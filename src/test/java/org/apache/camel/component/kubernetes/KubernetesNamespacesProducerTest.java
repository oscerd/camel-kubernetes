        ...
        return new RouteBuilder() {            
            ...
            public void configure() throws Exception {
                ...
                from("direct:createNamespace")
                        .toF("kubernetes://%s?username=%s&password=%s&category=namespaces&operation=createNamespace",host,username,password);
                from("direct:deleteNamespace")
                        .toF("kubernetes://%s?username=%s&password=%s&category=namespaces&operation=deleteNamespace",host,username,password);
            } 
        };
    }
}
