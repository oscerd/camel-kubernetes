    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {            
            ...
            public void configure() throws Exception {
                from("direct:list")
                        .toF("kubernetes://%s?username=%s&password=%s&category=secrets&operation=listSecrets",host,username,password);
                from("direct:listByLabels")
                        .toF("kubernetes://%s?username=%s&password=%s&category=secrets&operation=listSecretsByLabels",host,username,password);
                from("direct:get")
                        .toF("kubernetes://%s?username=%s&password=%s&category=secrets&operation=getSecret",host,username,password);
                from("direct:create")
                        .toF("kubernetes://%s?username=%s&password=%s&category=secrets&operation=createSecret",host,username,password);
                from("direct:delete")
                        .toF("kubernetes://%s?username=%s&password=%s&category=secrets&operation=deleteSecret",host,username,password);
            } 
        };
    }
}
