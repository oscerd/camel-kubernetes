    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {            
            ...
            public void configure() throws Exception {
                from("direct:list")
                        .toF("kubernetes://%s?username=%s&password=%s&category=services&operation=listServices",host,username,password);
                from("direct:listByLabels")
                        .toF("kubernetes://%s?username=%s&password=%s&category=services&operation=listServicesByLabels",host,username,password);
                from("direct:getServices")
                        .toF("kubernetes://%s?username=%s&password=%s&category=services&operation=getService",host,username,password);
                from("direct:createService")
                        .toF("kubernetes://%s?username=%s&password=%s&category=services&operation=createService",host,username,password);
                from("direct:deleteService")
                        .toF("kubernetes://%s?username=%s&password=%s&category=services&operation=deleteService",host,username,password);
            } 
        };
    }
}
