...
public class KubernetesPersistentVolumesClaimsProducer extends DefaultProducer {
    ...
    protected void doListPersistentVolumesClaimsByLabels(Exchange exchange, String operation) throws Exception {
    	...
    	if (!ObjectHelper.isEmpty(namespaceName)) {
    		ClientNonNamespaceOperation<KubernetesClient, PersistentVolumeClaim, PersistentVolumeClaimList, DoneablePersistentVolumeClaim, ClientResource<PersistentVolumeClaim, DoneablePersistentVolumeClaim>> pvcs;
    		pvcs = getEndpoint().getKubernetesClient().persistentVolumeClaims().inNamespace(namespaceName);
    		...
    		ClientOperation<KubernetesClient, PersistentVolumeClaim, PersistentVolumeClaimList, DoneablePersistentVolumeClaim, ClientResource<PersistentVolumeClaim, DoneablePersistentVolumeClaim>> pvcs;
